...
export function EquipmentCategoryBadge({
  ...
  return (
    <span
      className={cn(
        'inline-flex shrink-0 items-center rounded-full border border-teal-200 bg-teal-50 font-semibold text-teal-800 dark:border-teal-800/50 dark:bg-teal-950/40 dark:text-teal-200',
